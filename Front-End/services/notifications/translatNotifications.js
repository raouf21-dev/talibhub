  ...
  fr: {
    notifications: {
      success: {
        ...
        "surah.revision.congratulations":
          "Félicitations, tu as terminé ta session de révision !",
      ...
      warning: {
        // --- Timer et Sessions ---
        "timer.invalid_duration":
          "Durée invalide. Elle doit être entre 1 et 120 minutes",
        "session.required": "Une session active est requise",
        "session.required_timer":
          "Session active requise pour utiliser le timer",
        "session.required_stopwatch":
          "Session active requise pour utiliser le chronomètre",
        "session.required_manual":
          "Session active requise pour ajouter du temps manuel",
        "session.required_counter":
          "Session active requise pour utiliser le compteur",
        ...
        // --- Sourates ---
        "surah.memorization.select":
          "Veuillez sélectionner au moins une sourate à réviser",
        "surah.memorization.save":
          "Veuillez sélectionner au moins une sourate à enregistrer",
        ...
        "dua.angles.required":
          "Veuillez saisir les angles de Fajr et Isha pour la méthode personnalisée",
      ...
      error: {
        ...
        "timer.settings_load_error":
          "Erreur lors du chargement des paramètres du timer",
        "timer.settings_save_error":
          "Erreur lors de la sauvegarde des paramètres du timer",
        ...
        "surah.save.error":
          "Erreur lors de l'enregistrement des sourates connues",
        "surah.history.error": "Erreur lors du chargement de l'historique",
        "surah.history.clear.error":
        ...
        "mosque.geolocation.unsupported":
        ...
        // --- Duas ---
        "dua.geolocation.unsupported":
          "La géolocalisation n'est pas supportée par votre navigateur",
        "dua.geolocation.denied": "Accès à la géolocalisation refusé",
        "dua.geolocation.unavailable":
          "Information de localisation indisponible",
      ...
      confirm: {
        ...
        // --- Sourates ---
        "surah.history.clear":
          "Êtes-vous sûr de vouloir effacer tout l'historique de révision ? Cette action est irréversible.",
      },
  ...
  en: {
    notifications: {
      success: {
        ...
        "surah.revision.congratulations":
          "Congratulations, you have completed your revision session!",
      ...
      warning: {
        ...
        // --- Surahs ---
        "surah.memorization.select":
          "Please select at least one surah to revise",
        ...
        "dua.angles.required":
          "Please enter Fajr and Isha angles for custom method",
      ...
      confirm: {
        ...
        // --- Surahs ---
        "surah.history.clear":
          "Are you sure you want to clear all revision history? This action cannot be undone.",
      },
