...
export async function navigateTo(pageId, addToHistory = true) {
  ...
  const moduleLoaders = {
    welcomepage: async () => {
      const mod = await import('./welcomepage.js');
    ...
    mosquetime: async () => {
      const mod = await import('./mosqueTime.js');
    ...
    statistics: async () => {
      const mod = await import('./statistics.js');
    ...
    salatSurahSelector: async () => {
      const mod = await import('./surahSelector.js');
      await mod.initializeSurahSelector();
    },
    duaTimeCalculator: async () => {
      const mod = await import('./duaTimeCalculator.js');
      await mod.initializeDuaTimeCalculator();
    },
    surahmemorization: async () => {
      const mod = await import('./surahMemorization.js');
