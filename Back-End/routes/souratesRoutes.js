...
router.post('/by-numbers', authenticateToken, sourateController.getSouratesByNumbers);
...
router.get('/recitations/not-recited', authenticateToken, sourateController.getNotRecitedSourates);
router.post('/recitations/new-cycle', authenticateToken, sourateController.startNewCycle);

// Routes pour les niveaux de mémorisation
router.get('/memorization-status', authenticateToken, sourateController.getMemorizationStatus);
router.post('/memorization-status/:number', authenticateToken, sourateController.updateMemorizationStatus);

// Route pour l'historique de mémorisation
router.get('/memorization-history', authenticateToken, sourateController.getMemorizationHistory);

// Route pour effacer l'historique
router.delete('/memorization-history', authenticateToken, sourateController.clearMemorizationHistory);
