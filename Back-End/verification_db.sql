-- Script de vérification pour le système de mémorisation des sourates
-- Ce script vérifie que toutes les tables et colonnes sont bien configurées

\echo '=== VÉRIFICATION DU SYSTÈME DE MÉMORISATION DES SOURATES ==='
\echo ''
...
\echo ''
\echo '2. Structure de la table surah_memorization :'
SELECT 
...
\echo ''
\echo '3. Vérification des colonnes essentielles :'
SELECT 
    CASE 
...
\echo ''
\echo '4. Vérification des contraintes :'
SELECT 
...
\echo ''
\echo '6. Vérification des données de base (sourates) :'
SELECT 
...
\echo ''
\echo '7. Vérification de l\'ancienne colonne is_known :'
SELECT 
    CASE 
...
\echo ''
\echo '8. Statistiques du système de mémorisation :'
SELECT 
...
\echo ''
\echo '9. Répartition par niveau de mémorisation :'
SELECT 
    memorization_level as "Niveau",
    COUNT(*) as "Nombre"
FROM surah_memorization 
WHERE memorization_level IS NOT NULL
