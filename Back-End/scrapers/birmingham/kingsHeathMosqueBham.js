// Back-End/scrapers/birmingham/kingsHeathMosqueBham.js
...
const scrapeKingsHeathMosque = async () => {
   let browser;
   let page;

   try {
       console.log('Démarrage du scraping Kings Heath Mosque...');
       ...
       await page.goto('https://prayersconnect.com/mosques/82643541-kings-heath-mosque-birmingham-england-united-kingdom', {
       ...
       console.error('Erreur lors du scraping de Kings Heath Mosque:', error);
       throw error;
   } finally {
       if (browser) {
           await browser.close();
