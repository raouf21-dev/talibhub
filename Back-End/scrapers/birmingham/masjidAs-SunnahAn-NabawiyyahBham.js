...
const scrapeMasjidAsSunnah = async () => {
   ...
   try {
       ...
       await page.goto('https://mosquefinder.co.uk/masjid-as-sunnah-an-nabawiyyah/salaah-timings', {
       ...
       console.error('Erreur lors du scraping de Masjid As-Sunnah An-Nabawiyyah:', error);
       throw error;
   } finally {
       if (browser) {
           await browser.close();
