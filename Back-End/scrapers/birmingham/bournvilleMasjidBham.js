// Back-End/scrapers/birmingham/bournvilleMasjidBham.js
...
const scrapeBournvilleMasjid = async () => {
   let browser;
   let page;

   try {
       console.log('Démarrage du scraping Bournville Masjid...');
       ...
       await page.goto('https://mawaqit.net/en/sbmca-birmingham-b30-1qd-united-kingdom', {
       ...
       console.error('Erreur lors du scraping de Bournville Masjid:', error);
       throw error;
   } finally {
       if (browser) {
           await browser.close();
