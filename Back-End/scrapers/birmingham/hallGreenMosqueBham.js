// Back-End/scrapers/birmingham/hallGreenMosqueBham.js
...
const scrapeHallGreenMosque = async () => {
   let browser;
   let page;

   try {
       console.log('Démarrage du scraping Hall Green Mosque...');
       ...
       await page.goto('https://mosquefinder.co.uk/jamia-masjid-hall-green/salaah-timings', {
       ...
       const result = {
           source: 'Hall Green Mosque Birmingham',
       ...
       console.error('Erreur lors du scraping de Hall Green Mosque:', error);
       throw error;
   } finally {
       if (browser) {
           await browser.close();
...
module.exports = scrapeHallGreenMosque;