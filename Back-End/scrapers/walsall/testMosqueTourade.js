// Back-End/scrapers/birmingham/masjidEUsmanBham.js
...
const scrapetestMosqueTourade = async () => {
   let browser;
   let page;

   try {
       console.log('Démarrage du scraping Masjid-e-Usman...');
       ...
       const rawTimes = await page.evaluate(() => {
           const prayerTimes = {};
           const jamahElements = document.querySelectorAll('span.dpt_jamah:not(.prayerfinished)');
       ...
       console.error('Erreur lors du scraping de Masjid-e-Usman:', error);
       throw error;
   } finally {
       if (browser) {
           await browser.close();
...
module.exports = scrapetestMosqueTourade;