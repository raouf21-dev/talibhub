    ...
    const task = cron.schedule(cronExpression, async () => {
      ...
      try {
        ...
        if (timesExist) {
          ...
          try {
            // Émettre l'événement de démarrage du scraping automatique
            scrapingEventEmitter.emit("autoScrapingStarted", {
            ...
            // Émettre l'événement de completion du scraping automatique
            scrapingEventEmitter.emit("autoScrapingCompleted", {
              timestamp: new Date().toISOString(),
              status: "success",
            });
            ...
            // Émettre l'événement d'erreur du scraping automatique
            scrapingEventEmitter.emit("autoScrapingFailed", {
              timestamp: new Date().toISOString(),
              status: "error",
              error: scrapingError.message || scrapingError,
            });
