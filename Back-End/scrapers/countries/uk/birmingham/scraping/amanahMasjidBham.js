...
/**
 * SCRAPER OPTIMISÉ - scrapeAmanahMasjid
 ...
 * - Interception ressources (images, CSS, fonts)
 */
const scrapeAmanahMasjid = createOptimizedScraper(async (page) => {

    console.log("Navigation en cours...");

    await page.goto(
      "https://mawaqit.net/en/m/amanah-masjid-birmingham-b11-1jb-united-kingdom",
      {
