...
/**
 * SCRAPER OPTIMISÉ - scrapeHallGreenMosque
 ...
 * - Interception ressources (images, CSS, fonts)
 */
const scrapeHallGreenMosque = createOptimizedScraper(async (page) => {

    console.log("Navigation en cours...");

    await page.goto(
      "https://mosquefinder.co.uk/jamia-masjid-hall-green/salaah-timings",
      {
